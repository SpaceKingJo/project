...
mygame = Target(
    script="main.py", dest_base = "MyGame2", icon_resources = [(1, r"pico2d.ico")],
...
resource_folder = './resource/image'
...
resource_dlls = [resource_folder + file_name for file_name in os.listdir(resource_folder)]


setup(name="name",
      windows=[mygame],
      data_files=[('.', resource_folder), (sdl_folder, sdl_dlls)], # copy resource to '.' folder
      zipfile=None,
