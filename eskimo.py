...
class Eskimo:
    ...
    def __init__(self):
        ...
        if Eskimo.image == None:
            Eskimo.image = load_image('eskimo.png')
    ...
    def get_bb(self):
        return self.x - 55, self.y - 270, self.x + 55, self.y + 270
    ...
    def draw(self):
        # self.image.clip_draw(self.frame * 300, 600*2, 300, 600, self.x, self.y)
        ...
        if(self.alive == True):
            if(self.state == self.RIGHT_RUN):
                 ...
                 self.image.clip_draw(self.frame * 300, 0, 300, 600, self.x, self.y)
        # if(self.state == 4):
